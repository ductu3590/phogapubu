...
export default function ReservationDetailPage() {
  ...
  const preorders = useQuery({ queryKey: ["reservation-preorders", storeId, reservationId], queryFn: () => getPreorders(access!), enabled: !!access && query.data?.status === "confirmed" });
