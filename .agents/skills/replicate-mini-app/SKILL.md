...
## Lệnh nhanh: `onboard quán <slug>` (Codex tự sinh thư mục mini-app)

Khi anh Tú gõ `onboard quán <slug>` (thường sau khi chạy xong wizard `/mevo/stores/new`),
Codex làm TỰ ĐỘNG các bước sau — mỗi bước fail thì DỪNG và báo, không làm tiếp:
...
### 1. Business prerequisites (human does these, not Codex)
