-- BL-3 Task 5 hotfix: queue owner cần session_id để card arrived mở được bill POS.
-- Không thêm field này vào reservation_public_json vì projection đó còn được khách dùng.
